        ...
        return (
            ...
            <View style={styles.gifContainer}>
             ...
             style={{ width: size, height: size, alignSelf: "center" }}>
                 ...
                 <View> 
                <Text style={[styles.cardTitle, { marginTop: 400, marginLeft: 50 }]}></Text>{item.name} 
                    ...
                    </Text> <Text style={[styles.cardText, { marginTop: 5, marginLeft: 50 }]}>Minimum Diameter (KM) - {item.estimated_diameter.kilometers.estimated_diameter_min}</Text>
                    ...
                    <Text style={[styles.cardText,{ marginTop: 5, marginLeft: 50 }]}>Vel</Text>
                    ...
                    </Text> </View> </View> </ImageBackground>
